...
def plot_A_vs_C_triple(sigma_values, Q_values, A_range, line_style_list,colour_list):
    ...
    fig, axes = plt.subplots(nrows = 1, ncols = 3, constrained_layout=True, figsize= (10,5), sharey=True)
...
if __name__ == '__main__':
    ...
    plot_A_vs_C_triple(sigma_values, Q_values, A_range,line_style_list,colour_list)
    plt.show()
