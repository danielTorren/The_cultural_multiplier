...
def main(
    ...
    plot_SW_SBM(fileName, emissions_array_SW, emissions_array_SBM, r"Carbon price, $\tau$", property_varied, property_values_list, labels_SBM, seed_reps,colors_scenarios, emissions_fixed)
