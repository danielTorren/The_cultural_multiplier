...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        ...
        VARIABLE_PARAMS_LOAD = "package/constants/oneD_dict_budget.json",#"package/constants/oneD_dict_sigma.json",#"package/constants/oneD_dict_confirmation_bias.json",#"package/constants/oneD_dict_std_low_carbon_preference.json"
        RUN_TYPE = 5
)
