...
def main(
    ...
    #HIGH CARBON PRICE
    params["carbon_price_increased_lower"] = 1.0
    params["network_type"] = "SW"
...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        BASE_PARAMS_LOAD = "package/constants/base_params_networks_sub_conf_tau.json",
        VARIABLE_PARAMS_LOAD = "package/constants/variable_parameters_dict_2D_networks_sub_conf_tau.json",
    )
