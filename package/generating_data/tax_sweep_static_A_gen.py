...
def arrange_scenarios_no_tax(base_params,scenarios):
    ...
    base_params_copy["carbon_price_increased_lower"] = 0# no carbon tax
    base_params_copy["ratio_preference_or_consumption_state"] = 0 #WE ASSUME Consumption BASE LEARNING

    params_list = []
    #scenarios = [
    # "fixed_preferences",
    # "uniform_network_weighting", 
    # "static_socially_determined_weights",
    # "static_culturally_determined_weights", 
    # "dynamic_socially_determined_weights", 
    # "dynamic_culturally_determined_weights" 
    # ]
    ###### WITHOUT CARBON TAX
    ...
    if "dynamic_socially_determined_weights" in scenarios:
        base_params_copy_5 = deepcopy(base_params_copy)
    ...
    if "fully_connected_uniform" in scenarios:
        ...
        base_params_copy_7["alpha_change_state"] = "fixed_preferences"
        base_params_copy_7["network_density"] = 1
        params_sub_list_7 = produce_param_list_just_stochastic(base_params_copy_7)
        params_list.extend(params_sub_list_7)
        
    if "common_knowledge_dynamic_culturally_determined_weights" in scenarios:
        base_params_copy_8 = deepcopy(base_params_copy)
        base_params_copy_8["alpha_change_state"] = "common_knowledge_dynamic_culturally_determined_weights"
        params_sub_list_8 = produce_param_list_just_stochastic(base_params_copy_8)
...
def arrange_scenarios_tax(base_params_tax, carbon_tax_vals,scenarios):
    ...
    if "common_knowledge_dynamic_culturally_determined_weights" in scenarios:
        ...
        base_params_copy_8["alpha_change_state"] = "common_knowledge_dynamic_culturally_determined_weights"
        params_sub_list_8 = produce_param_list_scenarios_tax(base_params_copy_8, carbon_tax_vals,"carbon_price_increased_lower")
        params_list.extend(params_sub_list_8)
...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        BASE_PARAMS_LOAD = "package/constants/base_params_tau_vary_static_A.json",#"package/constants/base_params_tau_vary_timeseries.json",#"package/constants/base_params_tau_vary.json",
        VARIABLE_PARAMS_LOAD = "package/constants/oneD_dict_tau_vary_static_A.json",#"package/constants/oneD_dict_tau_vary_timeseries.json", #"package/constants/oneD_dict_tau_vary.json",
        #scenarios = ["uniform_network_weighting", "dynamic_socially_determined_weights"],
        scenarios = ["fixed_preferences","uniform_network_weighting", "static_socially_determined_weights","static_culturally_determined_weights", "dynamic_socially_determined_weights", "dynamic_culturally_determined_weights","common_knowledge_dynamic_culturally_determined_weights"],
        RUN_TYPE = 1
    )
