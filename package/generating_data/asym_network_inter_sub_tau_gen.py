...
def main(
    ...
    root = "asym_network_inter_sub_tau"
...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        BASE_PARAMS_LOAD = "package/constants/base_params_asym_networks_inter_sub_tau.json",
        VARIABLE_PARAMS_LOAD = "package/constants/variable_parameters_dict_2D_asym_networks_inter_sub_tau.json",
    )
