...
if __name__ == '__main__':
    ...
    "alpha_change_state": "dynamic_identity_determined_weights",#"dynamic_socially_determined_weights_cosine",#"dynamic_identity_determined_weights_cosine",
    "seed_reps": 3,
    "preferences_seed":8,
    ...
    "mean_low_carbon_substitutability": 1.01,
    "width_low_carbon_substitutability": 1,
    "state_minimum_h": 0,
    "h_m": [5e-7,5e-7],
