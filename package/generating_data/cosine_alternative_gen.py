...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        ...
        scenarios = ["dynamic_socially_determined_weights", "dynamic_identity_determined_weights", "dynamic_identity_determined_weights_cosine" ] #"dynamic_socially_determined_weights_cosine"
    )
