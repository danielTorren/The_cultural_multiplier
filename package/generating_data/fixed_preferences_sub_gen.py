...
def main(
    ...
    root = "fixed_preferences_nu_vary"
    ...
    emissions_array = emissions_stock_serial.reshape( len(carbon_price_list), property_reps, params["seed_reps"])#2 is for BA and SBM,3 is for the 3 differents states
...
if __name__ == '__main__':
    fileName_Figure_1 = main(
        BASE_PARAMS_LOAD = "package/constants/base_params_fixed_preferences.json",
        VARIABLE_PARAMS_LOAD = "package/constants/oneD_dict_fixed_preferences_nu.json",
    )
